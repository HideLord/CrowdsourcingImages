        ...
        <div className="margin">
            <Tabs>
                ...
                <TabPanel>
                    ...
                    <textarea className="rounded-corners margin-no-top textarea long-textarea" placeholder="Enter image URLs, separated by commas"></textarea>
                </TabPanel>
            </Tabs>
            <button className="blue-button margin-no-top long-button">Go</button>
        </div>
    )
}
